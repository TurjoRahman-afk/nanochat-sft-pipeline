...
def _maybe_compile(fn, **kwargs):
    return torch.compile(fn, **kwargs) if _USE_COMPILE else fn
...
adamw_step_fused = _maybe_compile(adamw_step_fused, dynamic=False, fullgraph=True)
...
muon_step_fused = _maybe_compile(muon_step_fused, dynamic=False, fullgraph=True)
