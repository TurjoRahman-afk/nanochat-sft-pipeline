...
class GPT(nn.Module):
    ...
    def _compute_window_sizes(self, config):
        ...
        return window_sizes
    """this is a 2D rotation matrix applied to pairs of dimensions -it encodes relatice position directly 
    into the dot product between the Q nad K, so attention naturally scores nearby tokens higher."""
